...
<!-- Identificador de Waltmart-->
            ...
            <input type="text" id="ja_idact" name="ja_idact" autocomplete="off" >
        	</div>
...
<!-- FECHAS (INICIAL Y FINAL)--> 
          ...
          <?php echo 'value="'.str_replace(" ","T",$_GET["i"]).'"'; ?> >
          </div>
      	  </div>
          <div class="form-group">
          ...
          <div class="col-sm-10">
            ...
            <?php echo 'value="'.str_replace(" ","T",$_GET["f"]).'"'; ?> >
          </div>
          </div>
         <br>
...
<!-- PRECIO (con iva)-->            
            ...
            <input type="number" id="precio" name="precio" autocomplete="off" step="any">
            </div>
