...
<div class="row">   
    ...
    <select name="sucur" class="form-control" id="sucur" required="true">
      ...
      <?php
        ...
        $resultado = odbc_exec($conexion, $sql); 
        while ($field = odbc_fetch_object($resultado)){
        echo '<option value="'.$field->nombre.'">'.$field->JA_NombreCuenta.'</option>';
        }
      ?>
...
//script de busqueda
 ...
 $('#search_btn').click(function(){
  ...
  var search = "SELECT       cliente, nombrecli, fecha, observacion,JA_Supervisor,sucursal, final, tipoEvento, Status, color, finalizado, Precio, JA_NombreCuenta FROM reporteEventos";
